...
- [x] **Реализовать систему аутентификации** - добавлены login/register/logout и bootstrap первого admin
- [x] **Добавить систему управления пользователями** - реализован `user` core-класс и таблица `users`
- [x] **Реализовать RBAC (Role-Based Access Control)** для разных уровней доступа - роли `viewer/operator/admin`, защита `machine/network/image`
- [ ] **Добавить сессии и токены** для безопасной аутентификации - сессии реализованы, токены пока не добавлены
