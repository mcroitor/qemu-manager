...
- [ ] **Улучшить валидацию входных данных** в `image.php` и `machine.php`
- [ ] **Добавить белые списки** для допустимых форматов изображений
- [ ] **Реализовать строгую валидацию** параметров виртуальных машин
- [ ] **Добавить экранирование SQL-запросов** (хотя используется PDO)
